...
func NewMinioRepository(cfg *config.AppConfig) *MinioRepository {
...
func (repo *MinioRepository) InvokeConnect(cfg *config.AppConfig) error {
	...
	repo.num_workers = cfg.Server.MaxParallelWorkers
