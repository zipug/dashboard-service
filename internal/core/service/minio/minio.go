...
func (m *MinioService) UploadFile(ctx context.Context, file models.File) (string, error) {
	return m.repo.UploadFile(ctx, file)
}

func (m *MinioService) UploadManyFiles(ctx context.Context, files []models.File) ([]string, error) {
...
func (m *MinioService) GetFileUrl(ctx context.Context, object_id, bucket string) (string, error) {
	return m.repo.GetFileUrl(ctx, object_id, bucket)
}

func (m *MinioService) GetManyFileUrls(ctx context.Context, object_ids []string, bucket string) ([]string, error) {
